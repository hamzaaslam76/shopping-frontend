...
<div className="flex justify-center mt-6">
  <Link to="/women-collections" className="bg-pink-600 text-white px-8 py-3 rounded-lg font-lato font-bold hover:bg-pink-700 transition flex items-center gap-2">
    View All 
